        ...
        <div className="bg-white-300 pt-20 pb-24 ">
            <div className="max-w-screen-xl w-full mx-auto px-6 sm:px-8 lg:px-16 grid grid-rows-6 sm:grid-rows-1 grid-flow-row sm:grid-flow-col grid-cols-3 sm:grid-cols-12 gap-4 text-silver">
                ...
                <div className=" row-span-2 sm:col-span-2 sm:col-start-7 sm:col-end-9 flex flex-col">
                    <p className="text-black mb-4 font-medium text-lg">Landings</p>
                    <ul className=" ">
                ...
                <div className="row-span-2 sm:col-span-2 sm:col-start-9 sm:col-end-11 flex flex-col">
                    <p className="text-black mb-4 font-medium text-lg">Company</p>
                    <ul className="">
                        <li className="my-2 hover:text-orange-500 cursor-pointer transition-all">
                            Home {" "}
                        </li>
                        <li className="my-2 hover:text-orange-500 cursor-pointer transition-all flex">
                            Careers <span className='ml-2 rounded-full px-3 text-center text-xs font-bold pt-1 bg-bermuda text-midnight animate-pulse'>
                                Hiring!
                            </span>
                        </li>
                        <li className="my-2 hover:text-orange-500 cursor-pointer transition-all">
                ...
                <div className="row-span-2 sm:col-span-2 sm:col-start-11 sm:col-end-13 flex flex-col">
                    <p className="text-black mb-4 font-medium text-lg">Resources</p>
                    <ul className="">
                        <li className="my-2 hover:text-orange-500 cursor-pointer transition-all">
                            Blog{" "}
                        </li>
